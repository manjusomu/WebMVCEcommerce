...
namespace WebAppEcommerce.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Brand,Model,Storage,Price")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Brand,Model,Storage,Price")] Laptop laptop)
        {
            if (ModelState.IsValid)
            {
